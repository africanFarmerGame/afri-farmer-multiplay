package uk.ac.sussex.view.components {
	 ...
	 * @author em97
	 */
	public class FinesGMOverviewDisplay extends MovieClip {
		private var scrollingList:ScrollingList;
		
		public function FinesGMOverviewDisplay() {
			setup();
		}
		public function clearFines():void {
			scrollingList.clearList();
		}
		public function addFine(hearth:Hearth, paid:int, unpaid:int, total:int):void {
			var fineItem:FinesGMOverviewListItem = new FinesGMOverviewListItem();
			fineItem.setDetails(hearth, paid, unpaid, total);
		...
		private function setupTitleBar():void {
			...
			var headers:Array = FinesGMOverviewListItem.getColumnHeaders();
