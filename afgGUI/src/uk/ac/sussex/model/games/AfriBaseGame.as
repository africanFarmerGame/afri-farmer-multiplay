...
package uk.ac.sussex.model.games {
	 ...
	 * @author em97
	 */
	public class AfriBaseGame extends BaseGame {
		public static const TYPE:String = "AFRI-GAME";
		public function AfriBaseGame() {
			super();
		...
		override public function registerGameStates(facade:IFacade, appMediator:ApplicationMediator, banker:Boolean):void {
			...
			appMediator.registerState(new AfriVillageGameState(facade));
			...
			appMediator.registerState(new ProposalGameState(facade));
