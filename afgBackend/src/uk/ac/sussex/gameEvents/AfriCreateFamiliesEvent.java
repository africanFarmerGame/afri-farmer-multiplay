...
public class AfriCreateFamiliesEvent extends GameEvent {

	public AfriCreateFamiliesEvent(Game game) {
		super(game);
	}
	...
	public void fireEvent() throws Exception {
		...
		while(itHearth.hasNext() && itFamilies.hasNext()){
			...
			int currentAdults = hearth.getCharacters().size() + 1; // I'm adding one here to allow for a man to join.
	...
	public void generateNotifications() throws Exception {
		...
		notification += "We have created a village for you. The women now have children.";
