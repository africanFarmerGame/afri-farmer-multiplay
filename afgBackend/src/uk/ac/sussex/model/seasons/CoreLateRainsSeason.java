...
public class CoreLateRainsSeason extends Season {
	public static String ID = "CoreLateRainsSeason";
	public static String NAME = "Main Rains";
	public CoreLateRainsSeason(Game game, Integer displayOrder){
		super(game, ID);
		this.name = NAME;
